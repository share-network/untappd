    ...
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
      ...
      >
        ...
        <li class="rounded-2xl bg-gray-800 px-8 py-10">
          ...
          <p class="text-sm leading-6 text-gray-400">Principal Designer</p>
          <ul role="list" class="mt-6 flex justify-center gap-x-6">
            <li>
              <a href="#" class="text-gray-400 hover:text-gray-300">
                <span class="sr-only">Twitter</span>
        ...
        <li class="rounded-2xl bg-gray-800 px-8 py-10">
          ...
          <p class="text-sm leading-6 text-gray-400">VP, User Experience</p>
          <ul role="list" class="mt-6 flex justify-center gap-x-6">
            <li>
              <a href="#" class="text-gray-400 hover:text-gray-300">
                <span class="sr-only">Twitter</span>
        ...
        <li class="rounded-2xl bg-gray-800 px-8 py-10">
          <img
            class="mx-auto h-48 w-48 rounded-full md:h-56 md:w-56"
            src="https://images.unsplash.com/photo-1500917293891-ef795e70e1f6?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=8&amp;w=1024&amp;h=1024&amp;q=80"
            alt=""
          />
          <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-white">
            Kristin Watson
          </h3>
          <p class="text-sm leading-6 text-gray-400">VP, Human Resources</p>
          <ul role="list" class="mt-6 flex justify-center gap-x-6">
            <li>
              <a href="#" class="text-gray-400 hover:text-gray-300">
                <span class="sr-only">Twitter</span>
        ...
        <li class="rounded-2xl bg-gray-800 px-8 py-10">
          ...
          <p class="text-sm leading-6 text-gray-400">Senior Developer</p>
          <ul role="list" class="mt-6 flex justify-center gap-x-6">
            <li>
              <a href="#" class="text-gray-400 hover:text-gray-300">
                <span class="sr-only">Twitter</span>
        ...
        <li class="rounded-2xl bg-gray-800 px-8 py-10">
          ...
          <p class="text-sm leading-6 text-gray-400">Junior Copywriter</p>
          <ul role="list" class="mt-6 flex justify-center gap-x-6">
            <li>
              <a href="#" class="text-gray-400 hover:text-gray-300">
                <span class="sr-only">Twitter</span>
